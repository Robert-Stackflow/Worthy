...
public class IconTextItem extends ConstraintLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attr != null) {
            ...
            int iconColor = attr.getColor(R.styleable.IconTextItem_icon_text_item_icon_color, getResources().getColor(R.color.checked_color));
            ...
            int textColor = attr.getColor(R.styleable.IconTextItem_icon_text_item_text_color, getResources().getColor(R.color.checked_color));
