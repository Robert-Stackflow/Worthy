...
public class SettingItem extends ConstraintLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (attr != null) {
            ...
            int titleColor = attr.getColor(R.styleable.SettingItem_setting_item_title_color, getResources().getColor(R.color.color_accent));
            setTitle(title, titleColor);
            String tip = attr.getString(R.styleable.SettingItem_setting_item_tip);
            int tipColor = attr.getColor(R.styleable.SettingItem_setting_item_tip_color, getResources().getColor(R.color.color_accent));
            setTip(tip, tipColor);
