...
public class EntryItem extends ConstraintLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attr != null) {
            ...
            int iconColor = attr.getColor(R.styleable.EntryItem_entry_item_icon_color, getResources().getColor(R.color.icon_color));
            ...
            int textColor = attr.getColor(R.styleable.EntryItem_entry_item_text_color, getResources().getColor(R.color.text_color_fast_entry));
