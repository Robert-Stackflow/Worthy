...
import com.cloudchewie.client.util.ui.DisplayUtil;
...
public class CornerTransform implements Transformation<Bitmap> {
    ...
    public static CornerTransform getTransform(Context context, boolean leftTop, boolean rightTop, boolean leftBottom, boolean rightBottom) {
        CornerTransform cornerTransform = new CornerTransform(context, DisplayUtil.dip2px(context, 10));
