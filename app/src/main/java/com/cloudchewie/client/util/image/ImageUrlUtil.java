...
public final class ImageUrlUtil {
    ...
    public static List<UserViewInfo> getViewInfos(List<String> urls) {
        List<UserViewInfo> infoList = new ArrayList<>();
        for (String url : urls)
            infoList.add(new UserViewInfo(url));
        return infoList;
    }
    ...
    public static List<String> getUrls(int range) {
        ...
        for (int i = 0; i < count; i++)
            pickedUrls.add(sUrls.get(((int) (Math.random() * 1000)) % 72));
        return pickedUrls;
    }
    ...
    public static List<UserViewInfo> getGifUrls() {
        ...
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170722/0847085229451104_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170721/0847085757949071_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170728/0847085265005650_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170730/0008118269110532_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170731/0008118203762697_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170727/0008118269666722_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170727/0008118269666722_s.jpg"));
        userViewInfos.add(new UserViewInfo("http://img44.photophoto.cn/20170727/0008118269666722_s.jpg"));
